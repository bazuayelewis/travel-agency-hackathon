    ...
    for country in country_data:
        ...
        if "idd" in country:
            ...
            if "root" in idd and "suffixes" in idd:
                country_code = ", ".join(
                    [idd["root"] + suffix for suffix in idd["suffixes"]]
                )
            elif "root" in idd:
        ...
        if "currencies" in country:
            ...
            currency_names = ", ".join(
                [currency["name"] for currency in country["currencies"].values()]
            )
            currency_symbols = ", ".join(
                [currency["symbol"] for currency in country["currencies"].values()]
            )
